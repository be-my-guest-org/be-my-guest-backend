...
WORKDIR /src
COPY ["BeMyGuest.Api.csproj", "BeMyGuest.Api/"]
RUN dotnet restore "BeMyGuest.Api/BeMyGuest.Api.csproj"

WORKDIR "/src/BeMyGuest.Api"
COPY . .
RUN dotnet build "BeMyGuest.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "BeMyGuest.Api.csproj" \
...
Execute unit tests
```
    cd "BeMyGuest.Api/test/BeMyGuest.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "BeMyGuest.Api/src/BeMyGuest.Api"
